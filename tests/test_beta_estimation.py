...
@pytest.fixture
def get_mocked_estimator(mocker):
    """Get mocked estimator"""

    def _create_mocked_estimator(*args):
        """Patch the object"""
        model = BetaEstimatorNoInitClass()
        for attr in args:
...
class TestRunBetaEstimator:
    ...
    def test_calculate_beta_parameters_is_called(self, mock_estimator) -> None:
    ...
    def test_run_sanity_checks_works(self, mock_estimator) -> None:
        ...
        test_estimator = BetaEstimatorNoInitClass()
    ...
    def test_calculate_beta_parameters_works(self) -> None:
